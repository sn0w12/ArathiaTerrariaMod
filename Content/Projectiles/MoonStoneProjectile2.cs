...
{
    public class MoonStoneProjectile2 : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            ProjectileHelper.DrawDustTrail(Projectile, texture, ModContent.DustType<TsukiDust>(), 0.1f, 1.2f);
        ...
        {
            Vector3 color = new Vector3(0.73f, 0.74f, 0.99f);
            // Add light at the projectile's position with the desired color
            Lighting.AddLight(Projectile.position, color.X, color.Y, color.Z);
